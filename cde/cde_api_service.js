...
app.factory('CDE', [ 'CDEWrite', 'CDEUtil', 'CDECache', 'CDEAuth',
 ...
 */
	...
	var init = function(config) {
		...
		// Initialize 
		CDERoot = 'http://' + location.host + '/#/CDE';
 ...
 */
	...
	var login = function(callback) {
	  ...
	  CDEAuth.loginWithGoogle(callback);
	...
	var autoLogin = function(redirect, callback) {
	  ...
	  if(!Statuses.init)
		...
		CDEAuth.checkGoogleLogin(function() {
			...
			var stay = (redirect === '#');
			var refresh = (location.href === CDERoot);

			if(location.href.indexOf(CDERoot) != -1)
